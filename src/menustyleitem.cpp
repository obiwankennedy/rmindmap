...
MenuStyleItem::MenuStyleItem(QWidget* parent) : QDialog(parent), ui(new Ui::MenuStyleItem)
{
    ui->setupUi(this);
...
void MenuStyleItem::initActions()
{
    ...
    connect(m_menuAct, &QAction::triggered, [=]() { ui->m_pageWidget->setCurrentIndex(0); });
    ...
    connect(m_fontAct, &QAction::triggered, [=]() { ui->m_pageWidget->setCurrentIndex(1); });
    ...
    connect(m_patelleAct, &QAction::triggered, [=]() { ui->m_pageWidget->setCurrentIndex(2); });
    ...
    connect(m_hierarchyAct, &QAction::triggered, [=]() { ui->m_pageWidget->setCurrentIndex(3); });
    ...
    connect(m_shapeAct, &QAction::triggered, [=]() { ui->m_pageWidget->setCurrentIndex(4); });
    ...
    connect(m_gatheringAct, &QAction::triggered, [=]() { ui->m_pageWidget->setCurrentIndex(5); });
